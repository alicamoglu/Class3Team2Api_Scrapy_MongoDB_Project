...
# Form implementation generated from reading ui file 'c:\Users\90506\Desktop\weather\weather_proje.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(700, 874)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.comboBox_country = QtWidgets.QComboBox(self.centralwidget)
        self.comboBox_country.setGeometry(QtCore.QRect(30, 240, 181, 41))
        font = QtGui.QFont()
        ...
        self.comboBox_city.setGeometry(QtCore.QRect(480, 240, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold SemiConden")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.label_city_name.setGeometry(QtCore.QRect(240, 310, 211, 71))
        font = QtGui.QFont()
        ...
        self.label_appname.setGeometry(QtCore.QRect(190, 90, 351, 71))
        font = QtGui.QFont()
        ...
        self.frame.setGeometry(QtCore.QRect(20, 410, 661, 131))
        ...
        self.label_temperature.setGeometry(QtCore.QRect(130, 50, 101, 51))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(24)
        font.setBold(True)
        ...
        self.label_icon_pressure.setGeometry(QtCore.QRect(560, 40, 31, 31))
        ...
        self.label_icon_pressure.setPixmap(QtGui.QPixmap(":/newPrefix/Downloads/resilience.png"))
        ...
        self.label_icon_huminity.setGeometry(QtCore.QRect(380, 40, 31, 31))
        self.label_icon_huminity.setStyleSheet("background-image: url(:/newPrefix/Downloads/humidity (1).png);")
        self.label_icon_huminity.setText("")
        self.label_icon_huminity.setPixmap(QtGui.QPixmap(":/newPrefix/Downloads/humidity (1).png"))
        ...
        self.label_icon_wind.setGeometry(QtCore.QRect(460, 40, 31, 31))
        self.label_icon_wind.setStyleSheet("background-image: url(:/newPrefix/Downloads/wind.png);")
        self.label_icon_wind.setText("")
        self.label_icon_wind.setPixmap(QtGui.QPixmap(":/newPrefix/Downloads/wind.png"))
        ...
        self.label_huminity.setGeometry(QtCore.QRect(390, 90, 51, 31))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        ...
        self.label_wind.setGeometry(QtCore.QRect(460, 90, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_pressure.setGeometry(QtCore.QRect(550, 90, 71, 31))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(10)
        font.setBold(True)
        ...
        self.label_weather_icon.setGeometry(QtCore.QRect(20, 30, 71, 61))
        ...
        self.comboBox_region.setGeometry(QtCore.QRect(250, 240, 181, 41))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold SemiConden")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.frame_2.setGeometry(QtCore.QRect(140, 590, 451, 201))
        ...
        self.label.setGeometry(QtCore.QRect(80, 20, 271, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_country_info.setGeometry(QtCore.QRect(210, 80, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_country_info_2 = QtWidgets.QLabel(self.frame_2)
        self.label_country_info_2.setGeometry(QtCore.QRect(200, 70, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        self.label_country_info_2.setFont(font)
        self.label_country_info_2.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.label_country_info_2.setText("")
        self.label_country_info_2.setObjectName("label_country_info_2")
        self.label_region_info = QtWidgets.QLabel(self.frame_2)
        self.label_region_info.setGeometry(QtCore.QRect(200, 115, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_population_info.setGeometry(QtCore.QRect(200, 160, 111, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.label_5.setGeometry(QtCore.QRect(40, 90, 91, 81))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_country.setItemText(2, _translate("MainWindow", "Turkey"))
        self.comboBox_country.setItemText(3, _translate("MainWindow", "USA"))
        self.comboBox_city.setItemText(0, _translate("MainWindow", "Select A City"))
        self.label_appname.setText(_translate("MainWindow", "  WEATHER APP"))
        self.comboBox_region.setItemText(0, _translate("MainWindow", "Select A Region"))
