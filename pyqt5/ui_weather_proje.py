...
# Form implementation generated from reading ui file 'c:\Users\qwert\OneDrive\Masaüstü\DATA SCIENCE\PROJECTS\PROJECT-3\Class3Team2Api_Scrapy_MongoDB_Project\pyqt5\weather_proje.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.table_cities.setGeometry(QtCore.QRect(30, 220, 531, 581))
        self.table_cities.setObjectName("table_cities")
        self.table_cities.setColumnCount(1)
        self.table_cities.setRowCount(2)
        item = QtWidgets.QTableWidgetItem()
        self.table_cities.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_cities.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_cities.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_cities.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.table_cities.setItem(1, 0, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_country_info.setText(_translate("MainWindow", "America"))
        item = self.table_cities.verticalHeaderItem(0)
        item.setText(_translate("MainWindow", "1"))
        item = self.table_cities.verticalHeaderItem(1)
        item.setText(_translate("MainWindow", "2"))
        item = self.table_cities.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "City"))
        __sortingEnabled = self.table_cities.isSortingEnabled()
        self.table_cities.setSortingEnabled(False)
        item = self.table_cities.item(0, 0)
        item.setText(_translate("MainWindow", "konya"))
        item = self.table_cities.item(1, 0)
        item.setText(_translate("MainWindow", "ankara"))
        self.table_cities.setSortingEnabled(__sortingEnabled)
import test_rc
